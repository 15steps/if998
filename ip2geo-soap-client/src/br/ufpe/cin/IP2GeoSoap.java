...
public interface IP2GeoSoap {
    ...
    @RequestWrapper(localName = "ResolveIP", targetNamespace = "http://ws.cdyne.com/", className = "br.ufpe.cin.ResolveIP")
    @ResponseWrapper(localName = "ResolveIPResponse", targetNamespace = "http://ws.cdyne.com/", className = "br.ufpe.cin.ResolveIPResponse")
